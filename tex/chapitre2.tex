...
Cependant, l'étude de la maturation cérébrale \emph{in vivo} ainsi que la définition d'outils diagnostiques prénataux ont conduit à la mise en place de méthodes permettant de traiter automatiquement ces images \cite{Studholme:ARBE:2010}.
