...
Des exemples d'utilisation de ce modèle sont donnés par les articles de \cite{Ashburner:NeuroImage:2000}, ajoutant une correction des inhomogénéités en intensité, de \cite{Dugas:MICCAI:2004}, ajoutant la prise en compte du volume partiel, ou par \cite{Ait:MICCAI:2005}, qui remplacent l'étape de maximisation de la vraisemblance par un estimateur de vraisemblance tamisé.
...
% Etant donné un Modélisation par mixtures de gaussienne, optimisation par l'algorithme EM et ajout des champs () ou chaînes de Markov pour la régularisation.
