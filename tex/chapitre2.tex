...
De manière générale, le signal reçu est modélisé comme le produit du \og vrai \fg{} signal et d'un champ de biais.
...
L'intensité est donc modélisée par : $\mathbf{y}_j = \mathbf{\dot{y}}_j + \gamma_j$, où $\mathbf{\dot{y}}_j$ représente la \og vraie \fg{} intensité au voxel $j$ et $\gamma_j$ représente l'intensité du biais au voxel $j$.
