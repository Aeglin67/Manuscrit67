...
Cette méthode est intéressante car elle introduit des contraintes anatomiques, cependant la phase de régularisation déconnectée des données n'est pas sans poser quelques problèmes car rien ne garanti que la labelisation peut se corriger automatiquement si elle n'est pas guidée par les données de l'image.
