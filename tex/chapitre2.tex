...
\cite{Heckemann:NeuroImage:2006} : Multi-atlas, décrit une méthode combinant recalage non-rigide et une méthode de fusion définie par \cite{Kittler:PAMI:1998} (définie quatre critère de décision : max, min, medium and vote majoritaire).
