...
Nous avons dressé un état des lieux de la segmentation des structures cérébrales en IRM.
...
L'avantage de FCM est qu'il procure une réponse native au problème du volume partiel en fournissant des fonctions d'appartenance à chaque tissus, tout en étant facilement extensible de manière à inclure de nouvelles fonctionnalités.
La prise en compte du biais en intensité se fait de manière couplée avec une étape d'évaluation des paramètres de l'inhomogénéité (ces derniers dépendant du modèle choisi).
