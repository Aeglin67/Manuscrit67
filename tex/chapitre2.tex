...
Ce chapitre présente les différentes familles de méthodes développées pour répondre à la problématique de la segmentation cérébrale.
...
Les méthodes de segmentation doivent prendre en compte les principales caractéristiques des imageurs par résonnance magnétique (décrites à la section \ref{intro:irm}) afin de parvenir à un résultat pertinent.
...
Enfin, une dernière section présentera un état de l'art des méthodes de segmentation dans le cadre de la maturation cérébrale.
