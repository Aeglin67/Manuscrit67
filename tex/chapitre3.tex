...
Cependant, les travaux sur les méthodes de débruitage par patchs (dont l'approche non-locale) ont montré que ces dernières étaient efficaces car elles offrent une estimation de la similarité plus fiable qu'une comparaison de la seule valeur des voxels~\cite{Salmon:2010}.
...
Les moyennes non-locales ainsi définies reposent sur deux hypothèses importantes~\cite{Szlam:UCLA:2008}: 
\begin{enumerate}
...
\subsection{Les paramètres des moyennes non-locales et leur influence}
