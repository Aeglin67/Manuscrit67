...
Comme vu dans la section~\ref{subsec:fcm:noise}, le terme de régularisation de la fonction d'énergie de FCM s'apparente la plupart du temps à l'expression d'un filtrage médian ou par moyenne pour lisser la segmentation, comme les articles de~\cite{Pham:CVIU:2001} et de~\cite{Ahmed:TMI:2002}.
