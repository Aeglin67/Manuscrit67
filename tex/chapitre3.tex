...
\begin{figure}[!t]
	...
	\subfigure[]{\includegraphics[height=45mm,angle=180]{eps/chapitre3/atlas_wm.eps}}
        ...
        \caption[Atlas utilisé pour initialiser certaines versions du FCM non-local]{\emph{Atlas ICBM utilisé pour initialiser certaines versions du FCM non-local. (a) Atlas du LCR, (b) atlas de la matière grise, (c) atlas de la matière blanche.}}
