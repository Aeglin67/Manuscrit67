...
\begin{itemize}
        ...
        \item \cite{Tasdizen:TIP:2009} : Débruitage par moyenne non-locale utilisant l'analyse en composante principale (issues de la décomposition de la matrice de covariance du vecteur de l'ensemble des voisinages).
