...
Ces méthodes de régularisation peuvent être vues comme des versions discrète d'un formalisme plus général appellé \emph{Non local data and smoothness term (NDS)}. 
