...
\end{center}
\caption{\emph{Différents noyaux utilisés dans le cadre des moyennes non-locales. Noir : noyau plat. Vert : noyau gaussien $K(x) = \exp{(-x)}$. Rouge : noyau compact polynomial de degré 4. Bleu : noyau compact polynomial de degré 6.}}
