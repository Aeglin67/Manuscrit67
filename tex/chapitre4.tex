...
\begin{figure}[!tb]
\centering
\subfigure[]{\includegraphics[height=39mm]{eps/chapitre4/TAB_Ar_02_HR.eps}} \label{axial:truth}
\subfigure[]{\includegraphics[height=39mm]{eps/chapitre4/TAB_Ar_02_SR.eps} \label{axial2:truth}}

\caption[Comparaison entre une image reconstruite selon \cite{Rousseau:AR:2006} et \cite{Rousseau:MIA:2010}]{
