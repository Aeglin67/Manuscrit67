...
\begin{figure}[!t]
	...
	\subfigure[]{\includegraphics[height=38mm]{eps/chapitre4/classif_3Class.eps}}
        \end{center}
        \caption[Illustration de clustering en deux et trois classes]{\emph{Illustration de clustering en deux et trois classes. (a) Image originale. (b) Clustering en deux classes. (c) Clustering en trois classes.}}
...
\begin{figure}[!t]
        ...
        \begin{center}
	\subfigure[]{\includegraphics[height=40mm]{eps/chapitre4/KMeans_Init.eps}\label{FIG:KMEANS:INIT}}
	\subfigure[]{\includegraphics[height=40mm]{eps/chapitre4/KMeans_Allowed1.eps}}
	\subfigure[]{\includegraphics[height=40mm]{eps/chapitre4/KMeans_Allowed2.eps}}\\
	\subfigure[]{\includegraphics[height=40mm]{eps/chapitre4/KMeans_NAllowed1.eps}}
	\subfigure[]{\includegraphics[height=40mm]{eps/chapitre4/KMeans_NAllowed2.eps}}
	\subfigure[]{\includegraphics[height=40mm]{eps/chapitre4/KMeans_NAllowed3.eps}}
        \end{center}
...
Dans ce cas précis, la prise en compte de contraintes géométriques ne permet pas de suivre le shéma classique de minimisation alternant évaluation des centroïdes des classes et classification des éléments de l'image en fonction de la distance par rapport aux centroïdes.
...
L'initialisation de ces trois cercles est réalisée par le biais d'une carte de distance intracrânienne, définie à partir d'une segmentation du volume intracrânien et mesurant le distance la distance d'un voxel par rapport à la frontière extérieure de ce volume.
...
\begin{figure}
	...
	\subfigure[]{\includegraphics[height=33mm]{eps/chapitre4/Cortex_Seg_Final.eps}}
        ...
        \caption[Segmentation du cortex - Méthodologie]{\emph{Segmentation du cortex. (a) Image originale. (b) En rouge, résultat du filtre \og Top-Hat \fg{} dans la zone d'intêret définie à partir de la frontière entre le LCR externe et le cerveau. (c) Zone d'intêret et initialisation des labels CSF, cortex et matière blanche. (d) Segmentation finale obtenue par le $k$-means topologique.}}
...
\end{center}
\caption[Coefficients Dice issus de la segmentation du cortex (images non reconstruites)]{\emph{Coefficients Dice illustrant le recouvrement entre la vérité terrain et les segmentations automatiques. Coefficient global et coefficient maximum coupe à coupe.}\label{TAB:DICE:UNBUILD}}
\end{table}
