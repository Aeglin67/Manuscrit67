...
Le cortex se présentant sous la forme d'une mince bande sombre, cette taille est suffisante pour mettre en avant le cortex par un filtre \og Top-Hat \fg{}.
...
Dans les cas où plus d'une vérité terrain est disponible, une comparaison quantitative est effectuée entre ces vérités terrain de manière à évaluer le degré d'accord des experts entre eux.
...
Ce constat est cependant peu surprenant, étant donné l'apparence des structures cérébrales vues dans une direction sagitale.
La zone du corps caleux est particulièrement inadaptée au modèles développé, tandis que les directions axiales et coronales sont adaptée au modèles.
Les valeurs des écarts-types montrent cependant une grande variabilité dans les résultats de la segmentation, qui peut s'expliquer largement par la qualité de l'image traité (présence d'un bruit plus ou moins important, cortex plus ou moins net, présence d'un hypersignal au sein de la matière blanche, \ldots).
Une plus grande dispersion est observée dans la direction sagittale, confirmant la plus faible adéquation du modèle à cette direction, tandis que les résultats obtenus en axial et coronale sont similaires.
...
Cependant, une ambiguité est introduite là ou le quatrième ventricule rejoint le LCR externe, conduisant à sur-évalué l'étendu de ce dernier et donc à définir une zone d'intêret trop large, provoquant l'apparition de faux positifs dans la segmentation, surtout dans la région autour du cervelet et du tronc cérébral.
...
La table~\ref{TAB:DICE:UNBUILD:EXP} rapporte les résultats de cette comparaison ainsi que les coefficients Dice entre la segmentation automatique et les différentes segmentations manuelles.
...
\hline
Case (GA)& \hspace{1mm} 1 (28) \hspace{1mm} & \hspace{1mm} 2 (30) \hspace{1mm} & \hspace{1mm} 3 (26) \hspace{1mm} & \hspace{1mm} 4 (32) \hspace{1mm} & \hspace{1mm} 5 (27) \hspace{1mm} & \hspace{1mm} 6 (30) \hspace{1mm}\\
\hline
