...
Cette initialisation fût choisie car elle permet non seulement d'avoir une zone d'intêret incluant le cortex, mais permet également d'avoir une quantité de voxels suffisamment grande de LCR et de matière blanche afin qu'effectuer un $k$-means topologique en trois classes ait un sens.
