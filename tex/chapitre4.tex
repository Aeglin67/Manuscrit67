...
L'initialisation des labels est faite par le calcul d'une carte de distance intra-crânienne depuis la surface extérieure du volume intracrânien (un voxel à $0$ signifie qu'il se situe hors de ce volume).
